...
1. Flipping the rect while resizing: While resizing, the rect can be flipped horizontally and vertically whenever the
...
2. Flipping the content of the box: This is done by using the `Transform.scale` widget with negative scale values. This
